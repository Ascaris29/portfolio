...
export default function CardProjects({classNameCard, classNameImg, img, classNameTitle, title, alt, classNameModale, data}){
    ...
    return(
        <>
            ...
            { modale ? <Modale title={title} data={data}/> : null}
        </>
    )
}